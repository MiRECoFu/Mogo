...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--batch_size', type=int, default=36, help='Batch size')
...
# python trainers/train_transformotion.py --dataset_name t2m --name trm_xl_b36_d1024_1204_downt_1_r_w_cmp_mx --vq_name rvq_n8192_d128 --gpu_id 0 --is_continue